...
const data = {
  ...
  alt: 'Hero Image',
  paragragh:
    'With a number of enterprise tools aimed at collating user information and providing access to financial services, we help businesses reach their targets wherever they may be and efficiently capture user data',
}
